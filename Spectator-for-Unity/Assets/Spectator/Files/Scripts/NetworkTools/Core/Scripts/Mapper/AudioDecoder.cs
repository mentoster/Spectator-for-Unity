...
public class AudioDecoder : MonoBehaviour
{
    ...
    [Header("Pair Encoder & Decoder")] public int label = 2001;
    int dataID = 0;
    int maxID = 1024;
    int dataLength = 0;
    ...
    void CreateClip()
    {
        if (samplerate != (int) SourceSampleRate || channel != SourceChannels)
        {
            ...
            myClip = AudioClip.Create("StreamingAudio", samplerate * SourceChannels, SourceChannels, samplerate, true,
