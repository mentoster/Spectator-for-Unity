                ...
                while (!stop)
                {
                    try
                    {
                        ...
                        if (ReceivedData.Length > 2)
                        {
                            ...
                            {
                                //others, skip sender
                                _packet.SkipIP = ClientEp.Address.ToString();
                            }
                        ...
                        //=======================Check is new client?=======================
                        Action_CheckClientStatus(ClientEp.Address.ToString());
                        //=======================Check is new client?=======================
    ...
    void UdpReceiveCallback(IAsyncResult ar)
    {
        if (ar.IsCompleted)
        {
            ...
            if (ReceivedData.Length > 2)
            {
                ...
                //others, skip sender
                if (ReceivedData[1] == 2) _packet.SkipIP = ClientEp.Address.ToString();
